        ...
        <div class="modal-body px-4 pb-4">
          ...
          <div class="row">
            ...
            <div class="col-12 mb-3">
              ...
              <!-- Excel Upload -->
              <input type="file" class="form-control" name="coordinators_file" accept=".xls,.xlsx" />
      ...
      <div class="modal-content">
        ...
        <div class="modal-body px-4 pb-4">
          ...
          <p class="text-center text-white-50" style="font-size:.85rem;">
            ...
            <span class="modal-link" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#signupModal">Sign
              Up</span>
          </p>
        </div>
      </div>
