...
<head>
    ...
    <title>Host Sign In – Confynex</title>
    ...
    <style>
        ...
        .card-footer-links a,
        .card-footer-links span.modal-link {
            color: var(--gold-light);
        ...
        .card-footer-links span.modal-link:hover {
            color: var(--gold);
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center g-5">
                ...
                <div class="col-lg-5 side-panel">
                    ...
                    <h2>Your events,<br><em>one secure login away.</em></h2>
                    <p class="lead-text">
                        Access your Host dashboard — manage conferences, track delegates, and oversee every session from one place.
                    </p>
                ...
                <div class="col-lg-5 col-md-8">
                    <div class="login-card">
                        ...
                        <div class="badge-gold"><i class="bi bi-box-arrow-in-right"></i> Host Portal</div>

                        <h1 class="card-title">Welcome <em>Back</em></h1>
                        <p class="card-sub">Sign in to your Host dashboard.</p>
                        ...
                        <form id="loginForm" action="hostLogin" method="post" novalidate>
                            ...
                            <div class="mb-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input
                                        ...
                                        required
                                    >
                                    <button type="button" class="btn btn-eye" id="togglePw" aria-label="Show password" title="Show password">
                            ...
                            <div class="text-end mb-4">
                                <a href="forgotPassword.jsp" style="color: var(--gold-light); font-size: 0.9rem; text-decoration: none;">
                                    Forgot Password?
                                </a>
                            </div>
